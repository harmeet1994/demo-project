...
const ShareModal = ({ isOpen, onClose, shareUrl = "https://jobschool.com/course/", title = "Share Link" }) => {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-auto">
        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            <h3 className="text-lg font-medium text-gray-900">Page Link</h3>
            <div className="flex items-center space-x-2 p-3 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
              <input
                type="text"
                value={shareUrl}
                readOnly
              ...
              <button
                onClick={handleCopy}
                className="flex items-center justify-center w-10 h-10 bg-yellow-400 hover:bg-yellow-500 rounded-lg transition-colors"
              >
                {copied ? (
