      ...
      <div class="mx-auto px-4 mt-10 container">
        ...
        <div class="mb-8">
          <div className='flex justify-center'>
            <h4 className='font-medium bg-[#FF9500] px-6 py-2 text-white rounded-3xl text-lg italic font-italic'>Learn smart. Grow fast. Get hired.</h4>
          </div>
          <h4 className='font-bold text-6xl mt-2 text-center leading-tight'>We’re not just teaching we are <br /> <span className='font-medium italic font-italic'>Transforming</span> futures</h4>
