                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 w-full lg:w-8/12 md:gap-8 gap-3 mb-8 lg:mb-0">
                            ...
                            <div>
                                ...
                                <div className="mt-2 space-y-2">
                                    <a href="tel:447832937148" className="flex items-center hover:text-blue-400">
                                        <img src="../assets/img/phone.png" className="h-5 mr-2" alt="" /> +44 78329 37148
                                    </a>
                                    <a href="mailto:contact@jobschool.io" className="flex items-center hover:text-blue-400">
                                        <img src="../assets/img/mail.png" className="h-5 mr-2" alt="" /> contact@jobschool.io
                                    </a>
